...
export default function DashboardLayout({
  ...
  return (
    <div className="relative h-screen w-full flex bg-[#03050D] text-white overflow-hidden">
      ...
      {/* SIDEBAR */}
      <aside className="relative h-full w-[260px] border-r border-white/10 backdrop-blur-2xl hidden md:flex">
      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        {/* HEADER */}
        <header className="border-b border-white/10 backdrop-blur-2xl">
          <Header />
        </header>
